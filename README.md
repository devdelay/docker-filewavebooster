...
You can use the version tag to run a specific version fo the booster if needed (eg. 12.1.0):

```bash
$ docker pull nielshojen/filewavebooster:12.1.0
$ docker run -d --restart always --name=filewavebooster \
  --restart="always" \
  -p 20003:20003 \
  -p 20004:20004 \
  ...
  -e FWBOOSTER_NAME="supercoolbooster" \
  -e FWSERVER1_ADDRESS="myfilewaveserver.mydomain.com" \
  nielshojen/filewavebooster:12.1.0
```
